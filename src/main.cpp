...
#if defined(NDEBUG)
# error "studentcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xe5fad861f2610055851f84769155b5e1ffb44f0e5d8035a046bcd40dd93212b6");
...
static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // studentcoin: 3 days
static const int64 nTargetSpacing = 2 * 60; // studentcoin: 2 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe5fad861f2610055851f84769155b5e1ffb44f0e5d8035a046bcd40dd93212b6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "StudentCoin was Created by Antonis Karantonis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e3bfc674dd4b56f4c84da2b4a759d4d0bd465f425cf489e52af2c091955bbdfc193e4ab4c845e0256d08f3200f38d2e85e66a7d5e84a0b800dbe0e06ed98f072") 
<< OP_CHECKSIG;
        CBlock block;
        ...
        block.nVersion = 1;
        block.nTime    = 1605190804;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085088325;

        if (fTestNet)
        {
            block.nTime    = 1605190784;
            block.nNonce   = 2085088325;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xb7625f0084de3a7836e41a0a7e7c2850278d9fddacec893e0edbcad4f56933d6"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc1, 0xb3, 0xda }; // studentcoin: increase each by adding 2 to bitcoin's value.
